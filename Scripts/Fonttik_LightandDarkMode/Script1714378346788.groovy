...
WebUI.click(findTestObject('Object Repository/Fonttik_LightAndDarkMode/Button_DarkMode'))

WebUI.click(findTestObject('Object Repository/Fonttik_LightAndDarkMode/Button_LightMode'))
