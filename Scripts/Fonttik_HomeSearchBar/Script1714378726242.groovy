...
WebUI.setText(findTestObject('Object Repository/Fonttik_Home/Box_HomeSearchBar'), 'wrc')

WebUI.sendKeys(findTestObject('Object Repository/Fonttik_Home/Box_HomeSearchBar'), Keys.chord(Keys.ENTER))

WebUI.verifyTextPresent('wrc iris menus', false)
